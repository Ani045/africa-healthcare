    ...
    <section className="py-10 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl lg:text-3xl font-bold text-[#154D92] mb-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-[#f0f7ff] p-4 rounded-lg text-center">
            <div className="w-10 h-10 bg-[#154D92] rounded-full flex items-center justify-center mx-auto mb-2">
              <Award className="w-5 h-5 text-white" />
            </div>
            <h3 className="font-semibold text-[#154D92] text-sm mb-1">JCI Accredited</h3>
          ...
          <div className="bg-[#f0f7ff] p-4 rounded-lg text-center">
            ...
            <h3 className="font-semibold text-[#154D92] text-sm mb-1">Expert Oncologists</h3>
          ...
          <div className="bg-[#f0f7ff] p-4 rounded-lg text-center">
            ...
            <h3 className="font-semibold text-[#154D92] text-sm mb-1">Global Patients</h3>
          ...
          <div className="bg-[#f0f7ff] p-4 rounded-lg text-center">
            ...
            <h3 className="font-semibold text-[#154D92] text-sm mb-1">Complete Support</h3>
