            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
                    {services.map((service, index) => (
                        ...
                        >
                            <div className="w-12 h-12 bg-[#154D92] rounded-full flex items-center justify-center mx-auto mb-2 text-white">
                                {service.icon}
                            </div>
                            <h3 className="font-medium text-[#154D92] text-xs lg:text-sm">
                                {service.title}
                            </h3>
                        </div>
                    ))}
